...
module.exports.run = async (client, message, args) => {
    ...
    if (!message.member.hasPermission("BAN_MEMBERS")) return message.reply("U kunt deze command niet uitvoeren!");

    if (!message.guild.me.hasPermission("BAN_MEMBERS")) return message.reply("De bot heeft geen permissions!");
    ...
    if(kickUser.hasPermission("MANAGE_MESSAGES")) return message.reply("U kunt deze gebruiker niet bannen!");
    ...
    var embed = new Discord.MessageEmbed()
        .setColor("#ff6f00")
        .setDescription(`${kickUser} ${kickUser.id} is gebant! | Reden: **${reason}** \n Door: ${message.author}`)
        .setTitle("Flevoland")
        .setFooter("Flevoland")
        .setTimestamp();
